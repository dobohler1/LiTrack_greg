function [inp_struc] = Load_history(type, time, varargin)
...
%lclsparams = Load_history(1, '07/04/2016 06:19:00', 'paramFileOutFn','Something_else(1).mat')
%lclsparams = Load_history(1,time,'paramFileOutFn','Something_else(1).mat')
...
%    BC1R56 = lcaGetSmart('SIOC:SYS0:ML00:AO484')*MM2M; % PV from CUD
    ...
    BC1_col2 = sync_value(:,2);     %refers to BC1_phase
    BC1E = BC1_col1;
    BC1R56 = BC1_col2;
...
%    BC2R56 = lcaGetSmart('SIOC:SYS0:ML00:AO490')*MM2M; % PV from CUD
    ...
    BC2_col2 = sync_value(:,2);     %refers to BC2_phase
