function [out] = LiTrack(fn,seed,z0in,dQ_Q,param,blnew,inp_struc,wake_fn, handles)
        ...
        %if nargout < 1
            ...
            if handles.doPlot
                ...
                if contf
                    ...
                    imagesc(X,Y,Zs);
                    axis xy
                    enerTitle=sprintf('%5.3f',Ebarcuts);
                    tt=datestr(handles.time, 0);
                    %savefile = ['File' enerTitle 'GeV' tt '.mat'];
                    handles.Zs = Zs;
                    guidata(handles.output, handles)
                    %save('bunchProfile.mat', 'X', 'Y','Zs');
                else
...
% end loop over all beamline section
